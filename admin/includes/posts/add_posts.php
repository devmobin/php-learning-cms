...
//        $date = escape(date('d-m-y'));
        ...
        echo "<p class='alert alert-success'>Post Created. <a class='alert-link' href='../post.php?id={$the_post_id}'>View Post </a> or <a class='alert-link' href='posts.php'>Edit More Posts</a></p>";
    }
?>
